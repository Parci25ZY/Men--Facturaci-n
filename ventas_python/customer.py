...
class RegularClient(Client):
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente minorista en la consola
        return {"dni":self.dni,"nombre":self.first_name,"apellido":self.last_name,"valor": self.discount, "card": self.card}
...
class VipClient(Client):
    ...
    def getJson(self):
        # Método para imprimir los detalles del cliente VIP en la consola
        return {"dni":self.dni,"nombre":self.first_name,"apellido":self.last_name,"valor": self.limit, "card":self.card}
